...
$idr = $_REQUEST['idr'];
 if (isset($idr) && $idr != '')
{
	 $sql = "DELETE  FROM m_si_organizaiton_section where id = $idr";
	$DB->execute($sql);
	redirect('section.php');
	$option = 0;
} 

sis_ui_page_title('Section');
...
echo '<div class="pull-right rc-attendance-teacher-print"><a title="Add Section" href="add_section.php?action=1"><i class="fa fa-plus-circle fa-lg"></i> Add Section</a></div>';



$form = sis_organization_section();
sis_ui_box('', $form);

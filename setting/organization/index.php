...
//set up breadcrumb
$PAGE->navbar->add('Organization', new moodle_url('index.php'));
//end of breadcrumb
...
$idr = $_REQUEST['idr'];
 if (isset($idr) && $idr != '')
{
	$sql = "DELETE  FROM m_si_organization where id = $idr";
	$DB->execute($sql);
	redirect('index.php');
	$option = 0;
}  
sis_ui_page_title('SIS organization');
...
echo '<div class="pull-right rc-attendance-teacher-print"><a title="Add Organization" href="add_organization.php?action=1"><i class="fa fa-plus-circle fa-lg"></i> Add Organization</a></div>';

<<<<<<< HEAD

=======
>>>>>>> 62fad2890f1d8f1375bdbd60832d51a0727f78a7
$form = sis_organization_index();
sis_ui_box('', $form);

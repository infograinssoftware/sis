...
certificate_print_text($pdf, $x, $y, 'C', 'tradbdo', '', 30, $certificate->name);
$pdf->SetTextColor(0, 0, 0);
certificate_print_text($pdf, $x, $y + 20, 'C', 'tradbdo', '', 20, $certificate->certified);
certificate_print_text($pdf, $x, $y + 36, 'C', 'tradbdo', '', 30, $certificate->statement);
...
certificate_print_text($pdf, $custx, $custy, 'L', 'tradbdo', '', 16, $certificate->signature_name);

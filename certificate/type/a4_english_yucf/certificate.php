...
//Dr. Mona Signature
$certificate->printsignature = 'mona' . '.jpg';
$sigx = 220;
$sigy = 60;
...
certificate_print_text($pdf, $x, $y + 22, '', $font, '', 20, $certificate->recepient);
certificate_print_text($pdf, $x, $y + 55, '', $font, '', 20, $student_id);
if($certificate->certified == '')
	$title_position = 87;
else
	$title_position = 84;
certificate_print_text($pdf, $x, $y + $title_position, '', $font, '', 20, $certificate->name);
certificate_print_text($pdf, $x, $y + $title_position + 9, '', $font, '', 20, $certificate->certified);

//certificate_print_text($pdf, $x, $y + 36, 'C', $font, '', 30, $certificate->statement);
